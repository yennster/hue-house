...
public final class HueBridgeClient: @unchecked Sendable {
    private let host: String
    private let applicationKey: String?
    private let bridgeSession: URLSession

    public init(host: String, applicationKey: String? = nil) {
    ...
    public static func discoverBridges() async throws -> [HueBridgeDiscovery] {
    ...
    public static func localDiscoveryDescription() -> String {
    ...
    public func createApplicationKey() async throws -> String {
    ...
    public func fetchLights() async throws -> [HueLight] {
    ...
    public func fetchGroups() async throws -> [HueLightGroup] {
    ...
    public func setLight(id: String, on: Bool) async throws {
        let payload = try JSONSerialization.data(
    ...
    public func setLight(id: String, brightness: Double) async throws {
    ...
    public func applyPreset(_ preset: HuePreset, to id: String) async throws {
    ...
    public func applyGradient(_ preset: HueGradientPreset, to light: HueLight, index: Int, total: Int) async throws {
...
private struct LocalIPv4Network {
    ...
    public func hostAddresses(limit: Int) -> [String] {
    ...
    public static func activeCandidates() -> [LocalIPv4Network] {
